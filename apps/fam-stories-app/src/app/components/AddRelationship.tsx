...
export function AddRelationship() {
    ...
    return <form onSubmit={onSubmit}>
        ...
        <select id="fromFamilyMemberId" value={fromFamilyMemberId} onChange={e => setFromFamilyMemberId(e.target.value)}>{familymemberOptionList}</select>
        <label htmlFor="toFamilyMemberId">To Family Member</label>
        <select id="toFamilyMemberId" value={toFamilyMemberId} onChange={e => setToFamilyMemberId(e.target.value)}>{familymemberOptionList}</select>
        <label htmlFor="relationtype">Relation Type</label>
        <select id="relationtype" value={relationtype} onChange={e => setRelationtype(e.target.value)}>{relationOptionlist}</select>
